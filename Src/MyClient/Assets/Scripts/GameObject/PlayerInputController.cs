...
public class PlayerInputController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (h < -0.1 || h > 0.1)
        {
            ...
            if (rot.eulerAngles.y > this.trunAngle && rot.eulerAngles.y < (360 - this.trunAngle))
            {
        ...
        //Debug.LogFormat("velocity{0}",this.rb.linearVelocity.magnitude);
    }
